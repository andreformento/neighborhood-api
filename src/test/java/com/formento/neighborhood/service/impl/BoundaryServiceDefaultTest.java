...
public class BoundaryServiceDefaultTest {

    @InjectMocks
    private BoundaryServiceDefault boundaryService;
    @Mock
    ...
    @Before
    public void init() {
        boundaryServiceDefaultBDD = new BoundaryServiceDefaultBDD(boundaryService, boundaryRepository);
    }
